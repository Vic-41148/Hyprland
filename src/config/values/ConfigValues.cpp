...
#define MS makeConfigValue
    ...
    return std::vector<SP<IValue>>{
        ...
        MS<Bool>("layout:single_window_aspect_ratio_apply_on_maximize",
                 "If true, single_window_aspect_ratio will also be applied when a window is maximized (fullscreen, 1). Default: false.", false,
